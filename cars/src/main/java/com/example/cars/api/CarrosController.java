...
public class CarrosController {
    ...
    public ResponseEntity get(@PathVariable("id") Long id) {
        CarroDTO carro = service.getCarsById(id);

        return ResponseEntity.ok(carro);
    }

    @GetMapping("/tipo/{tipo}")
    public ResponseEntity<List<CarroDTO>> getCarrosByType(@PathVariable("tipo") String tipo) {
        List<CarroDTO> carros = service.getCarsByType(tipo);
